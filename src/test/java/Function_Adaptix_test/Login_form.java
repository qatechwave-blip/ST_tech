...
public class Login_form extends BaseTest {
    ...
    @FindBy(xpath = "//button[normalize-space()='Sign in']") WebElement btn_login;
    @FindBy(xpath = "//div[contains(@class,'dashboard')]") WebElement dashboardElement;
    ...
    public void signINBTN() {
        Wait_Class.waitForClickable(driver, btn_login, 0);
        btn_login.click();
